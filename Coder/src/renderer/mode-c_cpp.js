...
ace.define("ace/mode/c_cpp_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function (require, exports, module) {
    ...
    var c_cppHighlightRules = function () {
        ...
        var keywordOperators = (
            ...
            "const_cast|dynamic_cast|reinterpret_cast|static_cast|sizeof|namespace|abstract|async|await|event|new|struct|as|explicit|null|switch|base|extern|object|this|bool|false|operator|throw|break|finally|out|true|byte|fixed|override|try|case|float|params|typeof|catch|for|private|uint|char|foreach|protected|ulong|checked|goto|public|unchecked|class|if|readonly|unsafe|const|implicit|ref|ushort|continue|in|return|using|decimal|sbyte|virtual|default|interface|sealed|volatile|delegate|internal|partial|short|void|do|is|sizeof|while|double|lock|stackalloc|else|long|static|enum|namespace|string|var|dynamic|string|WriteLine" +
            "add|alias|ascending|async|await|by|descending|dynamic|equals|from|get|global|group|into|joinlet|nameof|on|orderby|partial|type|partial|method|remove|select|set|unmanaged|generic|type|constraint|value|varwhen|filter|condition|where|generic|type|constraint|where|query|clause|yield"
        ...
        var keywordMapper = this.$keywords = this.createKeywordMapper({
            ...
            "variable.language": "this|main|Console|Main|using",
